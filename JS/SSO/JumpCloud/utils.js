...
export async function deleteUserFromGroup (sso, userInfo, grpInfo) {
  const deleteUserFromGroup = axios.post(`https://console.jumpcloud.com/api/v2/usergroups/${grpInfo.groupId}/members`, {
    op: 'remove',
    type: 'user',
    id: `${userInfo.userId}`
  }, {
...
export async function addUserToGroup (sso, userInfo, grpInfo) {
  const addUserToGroup = axios.post(`https://console.jumpcloud.com/api/v2/usergroups/${grpInfo.groupId}/members`, {
    op: 'add',
    type: 'user',
    id: `${userInfo.userId}`
  }, {
